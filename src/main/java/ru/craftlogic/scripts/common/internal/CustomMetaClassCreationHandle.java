package ru.craftlogic.scripts.common.internal;
    ...
    protected MetaClass createNormalMetaClass(Class theClass, MetaClassRegistry registry) {
        if (GeneratedClosure.class.isAssignableFrom(theClass)) {
            ...
            return new MetaClassImpl(registry, theClass) {
                ...
                private Object getPropertyOrGetSetMethod(Class sender, Object object, String name, boolean useSuper, boolean fromInsideClass) {
                    try {
                ...
                public Object getProperty(Class sender, Object object, String name, boolean useSuper, boolean fromInsideClass) {
                    if (obfuscated) {
                        ...
                        if (obfName != null && !obfName.equals(name)) {
                            try {
                                return this.getPropertyOrGetSetMethod(sender, object, obfName, useSuper, fromInsideClass);
                            } catch (MissingPropertyException e) {
                                String notchName = DeobfManager.notchFieldName(targetClass, obfName);
                                if (notchName != null && !notchName.equals(obfName)) {
                                    return this.getPropertyOrGetSetMethod(sender, object, notchName, useSuper, fromInsideClass);
                                }
                            }
                        }
                    }
                ...
                private MetaProperty getEffectiveGetMetaPropertyOrGetSetMethod(Class sender, Object object, String name, boolean useSuper) {
                    try {
                ...
                public MetaProperty getEffectiveGetMetaProperty(Class sender, Object object, String name, boolean useSuper) {
                    if (obfuscated) {
                        ...
                        if (obfName != null && !obfName.equals(name)) {
                            try {
                                return this.getEffectiveGetMetaPropertyOrGetSetMethod(sender, object, obfName, useSuper);
                            } catch (MissingPropertyException e) {
                                String notchName = DeobfManager.notchFieldName(targetClass, obfName);
                                if (notchName != null && !notchName.equals(obfName)) {
                                    return this.getEffectiveGetMetaPropertyOrGetSetMethod(sender, object, notchName, useSuper);
                                }
                            }
                        }
                    }
                ...
                public synchronized void initialize() {
                    if (!isInitialized()) {
                        super.initialize();
                        //Private members first (to prevent private parent members overriding public own members)
                        ...
                        inheritPrivateFields(superClasses);
                    }
                }
